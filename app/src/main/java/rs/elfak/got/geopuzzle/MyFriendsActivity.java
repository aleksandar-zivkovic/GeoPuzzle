                ...
                if (json.getString(Cons.KEY_SUCCESS) != null) {
                    ...
                    if(Integer.parseInt(res) == 1) {
                        ...
                        if(friendsNum == 0)
                            ...
                            FriendList adapter = new FriendList(MyFriendsActivity.this, friendNames.toArray(new String[friendNames.size()]), friendEmails.toArray(new String[friendEmails.size()]), friendPhoneNums.toArray(new String[friendEmails.size()]));
