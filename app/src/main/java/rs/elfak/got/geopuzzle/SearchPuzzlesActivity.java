...
public class SearchPuzzlesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_puzzles);
    ...
    private class NetCheck extends AsyncTask {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(SearchPuzzlesActivity.this);
    ...
    private class ProcessMyPuzzles extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SearchPuzzlesActivity.this);
        ...
        protected Object doInBackground(Object[] params) {
            ...
            return userFunction.fetchSearchPuzzles(getApplicationContext(), mSearchText);
        }
                ...
                if (json.getString(Cons.KEY_SUCCESS) != null) {
                    ...
                    if(Integer.parseInt(res) == 1) {
                        ...
                        if(puzzleNum == 0) {
                            ...
                            PuzzleList adapter = new PuzzleList(SearchPuzzlesActivity.this, puzzleTitles.toArray(new String[puzzleTitles.size()]), numOfChunks.toArray(new String[numOfChunks.size()]));
