...
public class SearchFriendsActivity extends AppCompatActivity {
    ...
    private class NetCheck extends AsyncTask {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(SearchFriendsActivity.this);
    ...
    private class ProcessMyFriends extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SearchFriendsActivity.this);
        ...
        protected Object doInBackground(Object[] params) {
            ...
            return userFunction.fetchSearchedFriends(getApplicationContext(), mSearchText);
        }
